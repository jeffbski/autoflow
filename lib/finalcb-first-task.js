...
function FinalCbFirstSuccTask(taskDef, cbFunc, tasks, vCon, execOptions) {
  var self = this;
...
FinalCbFirstSuccTask.create = function (taskDef, cbFunc, tasks, vCon, execOptions) {
  if (!(cbFunc && cbFunc instanceof Function)) throw new Error('callback is not a function'); 
  return new FinalCbFirstSuccTask(taskDef, cbFunc, tasks, vCon, execOptions);
};
