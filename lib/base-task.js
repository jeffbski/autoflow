...
BaseTask.prototype.start = function (args) { // mark task as started with args and note time
  ...
  if (this.flowEmitter) this.flowEmitter.emit(EventManager.TYPES.EXEC_TASK_START, taskAndArgs);
};
...
/*jshint validthis: true */
  ...
  if (this.flowEmitter) this.flowEmitter.emit(EventManager.TYPES.EXEC_TASK_COMPLETE, taskAndArgs);
};
