...
function (util, sprintf, array, CbTask, PromiseTask,
  ...
  */
  ...
  function isIteratingFlow(ast) {
    return (ast.arrayIterator);
  }

  /**
     Determine if ast has an accumulator defined, and if so return the name,
     else return falsy value
    */
  function hasAccumulator(ast) {
    return ast.arrayMapAccumulator;
  }
  ...
  return {
    ...
    isIteratingFlow: isIteratingFlow,
