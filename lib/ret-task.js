...
RetTask.prototype.exec = function exec(vCon, handleError) {
  try {
    ...
    this.getVCon()[this.ret] = func.apply(bindObj, args);  //  save retval
    this.complete();
    this.boundContExec();                     // continue since no callback to run this
