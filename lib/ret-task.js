...
/**
   If ret params are obj property writes make sure the dst object
   is defined and not null. ret: 'b.c' -> b is def and not null
   @returns true if all obj prop parent is def and non null
  */
RetTask.prototype.outParentsExist = function (vCon) {
  if (this.ret === null) return true; // not saving result anyway 
  return this.parentExists(this.ret, vCon);
};
